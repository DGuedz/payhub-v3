...
```
payhub-frontend/
├── app/page.tsx              # Página principal com toda UI
├── components/mvp/
│   ├── HeroSection.tsx       # Hero completo
│   ├── ProcessFlow.tsx       # 3 steps visualization
...
1. **Internacionalização Completa**
   ...
   - English: "On-Demand Liquidity"
   - Todos os textos traduzidos

2. **Interatividade Real**
   - Simulação de conversão ODL (3 segundos)
   - Loading animations
...
```tsx
// Hero com gradiente perfeito
<h1 className="bg-gradient-to-r from-white to-blue-400 bg-clip-text text-transparent">
...
3. **Conectar Supabase** para analytics
